  ...
  return (
    <div className="main-shimmer p-0 flex flex-col items-center justify-center sm:flex-row sm:flex-wrap  space-y-3">
      ...
      {Array(20)
        ...
        .map((each) => (
          <div
            className="shimmer w-full sm:h-[370px] sm:max-w-[260px] flex sm:flex-col border shadow-md rounded-md p-2 sm:mr-2 md:mr-5 space-y-2"
            key={uuidV4()}
          >
            <div className="w-24 h-24 sm:w-full xs:h-44 xs:w-48 rounded-md bg-gray-200 sm:mb-2 flex-shrink-0 mr-5 sm:mr-0"></div>
